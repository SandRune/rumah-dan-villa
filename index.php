        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="img/nicebed1.jpg" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">Find The Perfect Bed For You.</h1>
                                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Search A Rooms</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="img/exterior.jpg" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
        ...
        <div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <div class="row g-2">
                    <!-- Location -->
                    <div class="col-md-4">
                        <label for="location" style="color: black; font-weight: bold;">Location</label>
                        <input type="text" class="form-control border-0" id="location" placeholder="Location" style="margin-top: 5px; border-radius: 0;" />
                    </div>
                    <!-- Home Type -->
                    <div class="col-md-4">
                        <label for="homeType" style="color: black; font-weight: bold;">Home Type</label>
                        <select class="form-select border-0" id="homeType" style="margin-top: 5px; border-radius: 0;">
                    ...
                    <!-- How Many Guests -->
                    <div class="col-md-4">
                        <label for="numberChoice" style="color: black; font-weight: bold;">How Many Guests</label>
                        <input type="number" class="form-control border-0" id="numberChoice" name="numberChoice" min="1" max="15" style="margin-top: 5px; border-radius: 0;" />
                    </div>
                </div>
                <div class="row g-2 mt-3">
                    <!-- Date In -->
                    <div class="col-md-6">
                        <label for="dateIn" style="color: black; font-weight: bold;">Date In</label>
                        <input type="date" class="form-control border-0" id="dateIn" name="dateIn" style="margin-top: 5px; border-radius: 0;" />
                    </div>
                    <!-- Date Out -->
                    <div class="col-md-6">
                        <label for="dateOut" style="color: black; font-weight: bold;">Date Out</label>
                        <input type="date" class="form-control border-0" id="dateOut" name="dateOut" style="margin-top: 5px; border-radius: 0;" />
                    </div>
                </div>
                <div class="row g-2 mt-3">
                    <!-- Search Button -->
                    <div class="col-md-12" style="color: black; font-weight: bold;">
                        <button class="btn btn-dark border-0 w-100" style="border-radius: 0;">Search</button>
                    </div>
                </div>
            </div>
        </div>
